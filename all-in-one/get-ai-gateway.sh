...
if not auto_routing.get('enable', False):
    ...
    print()
    print("Use 'config set' command to update auto-routing configuration:")
    print("  ./get-ai-gateway.sh config set ENABLE_AUTO_ROUTING true")
    print()
    print("Or use 'route add' command to manage rules.")
    sys.exit(0)
...
if not rules:
    ...
    print("  ./get-ai-gateway.sh route add --model <model> --pattern <regex-pattern>")
else:
